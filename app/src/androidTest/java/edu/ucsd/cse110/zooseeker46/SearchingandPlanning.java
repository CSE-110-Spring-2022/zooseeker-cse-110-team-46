...
public class SearchingandPlanning {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void searchingandPlanning() {
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(androidx.appcompat.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("alli"), closeSoftKeyboard());
        ...
        ViewInteraction searchAutoComplete2 = onView(
                allOf(withId(androidx.appcompat.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete2.perform(replaceText("uni"), closeSoftKeyboard());
        ...
        ViewInteraction searchAutoComplete3 = onView(
                allOf(withId(androidx.appcompat.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete3.perform(replaceText("el"), closeSoftKeyboard());
